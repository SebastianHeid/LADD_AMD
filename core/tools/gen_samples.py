...
import torch
from diffusers import DDPMScheduler, DiffusionPipeline, PixArtSigmaPipeline
...
if args.model == "sd21base":
    ...
    pipe_kwargs = {"num_inference_steps": 1, "guidance_scale": 0, "timesteps": [999]}
    ...
    pipe_kwargs = {"num_inference_steps": 1, "guidance_scale": 0, "timesteps": [400]}
...
with open(args.prompt_path, "r") as f:
    ...
    prompt_list = []
    for line in lines:
        prompt_list.append(line.strip().split("----")[1])
...
with torch.no_grad():
    ...
    for id_ind, cur_caption in enumerate(prompt_list):
        ...
        image = pipe(prompt=cur_caption, generator=generator, **pipe_kwargs).images[0]
        image.save(outpath)
